...
<head>
	...
	<link rel="shortcut icon" href="<?php echo e(asset('images/iPOST Logo.ico')); ?>">
...
<body>
	...
	<div class="contact">
		...
		<div class="contact-links">
			<a href="">
				<img src="<?php echo e(URL::asset('/images/fb.png')); ?>">
			</a>
			<a href="">
				<img src="<?php echo e(URL::asset('/images/google.png')); ?>">
			</a>
			<a href="">
				<img src="<?php echo e(URL::asset('/images/twitter.png')); ?>">
			</a>
			<a href="">
				<img src="<?php echo e(URL::asset('/images/instagram.png')); ?>">
			</a>
		</div>
	</div>
	<div>
	...
	<script type="text/javascript" src="<?php echo e(asset('jquery/jquery-3.1.1.min.js')); ?>"></script>
